...
const LEVELS = {
  ...
  /*
     ...
     Three rules, and they're the whole reason it works:
       ...
       ONE NEW THING AT A TIME.  Run. Then jump. Then swing. Then the
       portal. Never two at once.
  ...
  */
  'tutorial': {
    ...
    hints: [
      ...
      { col: 36, row: 1, text: 'press  \u25c0  \u25b6  to swing higher' },
      { col: 48, row: 3, text: 'walk into the portal to finish' },
    ],
